...
async function finishWizard() {
  ...
  try {
    ...
    const { enviarEmailRegistro } = await import('./email-service.js?v=20260517j');
...
export async function startWizard() {
  ...
  try {
    const [firmaMod, datosMod, tokenMod, tribMod, factMod, claveMod, logoMod] = await Promise.all([
      import('./screen-firma.js?v=20260517j'),
      import('./screen-datos.js?v=20260517j'),
      import('./screen-token.js?v=20260517j'),
      import('./screen-tributaria.js?v=20260517j'),
      import('./screen-facturacion.js?v=20260517j'),
      import('./screen-clave.js?v=20260517j'),
      import('./screen-logo.js?v=20260517j'),
    ]);
