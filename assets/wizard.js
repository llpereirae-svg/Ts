...
async function finishWizard() {
  ...
  try {
    ...
    const { enviarEmailRegistro } = await import('./services/email-service.js?v=20260518b');
...
export async function startWizard() {
  ...
  try {
    const [firmaMod, datosMod, tokenMod, tribMod, factMod, claveMod, logoMod] = await Promise.all([
      import('./screens/screen-firma.js?v=20260518b'),
      import('./screens/screen-datos.js?v=20260518b'),
      import('./screens/screen-token.js?v=20260518b'),
      import('./screens/screen-tributaria.js?v=20260518b'),
      import('./screens/screen-facturacion.js?v=20260518b'),
      import('./screens/screen-clave.js?v=20260518b'),
      import('./screens/screen-logo.js?v=20260518b'),
    ]);
